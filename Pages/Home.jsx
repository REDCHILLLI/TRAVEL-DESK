...
const Home = () => {
  ...
  // Auto-set admin context if not already set
  ...
  // Otherwise, render normal home page
  return (
    <>
      <section>
        <Container>
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <p>
                  A3 holidays is your trusted travel companion, connecting you
                  to breathtaking destinations across the globe. We handle every
                  detail — from bookings to local experiences — so you can focus
                  on creating lifelong memories.
                </p>
              </div>
            </Col>
            <Col lg="2">
          ...
          <Row>
            <Col lg="6">
              <div className="experience__content">
                ...
                <h2>
                  All experience of our A3 company
                  <br /> will serve you
                </h2>
                <p>
                  Where your travel dreams turn into unforgettable memories.
                  <br />
                  Discover. Dream. Depart. The world is waiting for you!
                </p>
              </div>
